...
public class ProCountKpi : IKpiCalculator
{
    public string KpiName => "Pro Count";
    private readonly IMongoCollection<User> _users;

    public ProCountKpi(IConfiguration config)
    {
    ...
    {
        var filter = Builders<User>.Filter.Eq(u => u.Type, "Pro");
