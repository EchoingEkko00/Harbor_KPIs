...
public class NewProsThisTodayKpi : IKpiCalculator
{
    public string KpiName => "New Pros Last 24hrs";
    private readonly IMongoCollection<User> _users;

    public NewProsThisTodayKpi(IConfiguration config)
    {
    ...
    public async Task<KpiResult> CalculateAsync()
    {
        ...
        var filter = Builders<User>.Filter.And(
            Builders<User>.Filter.Eq(u => u.Type, "Pro"),
